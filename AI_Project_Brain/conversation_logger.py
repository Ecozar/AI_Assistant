...
from AI_Project_Brain.app import get_ui_settings  # Fix the import path
from AI_Project_Brain.db_manager import db_manager
from AI_Project_database.auto_tagging import get_suggested_tags  # Add this import
from AI_Project_Brain.logging_config import configure_logging
import uuid
from typing import List, Dict, Optional, Any
from datetime import datetime
from .model_manager import model_manager
from .auto_tagger import auto_tagger
...
def log_interaction(conversation_id: str, message: str, response: str) -> None:
    ...
    try:
        ...
        suggested_tags = auto_tagger.get_suggested_tags(
            message, 
            threshold=MEMORY_SETTINGS['auto_tag']['default_threshold']
        )
        valid_tags = [tag for tag, confidence in suggested_tags]
...
def get_conversation_context(conversation_id: str, limit: int = None) -> list:
    """Get conversation history"""
    try:
        settings = get_ui_settings()
        limit = limit or settings.get("conversation_limit")
